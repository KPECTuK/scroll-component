...
{
	public class OneItemHopCoDirectionCarrier<TData> : CarrierBase<TData> where TData : class
	{
		...
		public OneItemHopCoDirectionCarrier(IScrollComponent<TData> component)
		{
			...
			first?.RectTransform.GetIntersectionInParentSpace(new Straight { Direction = -GrowDirection }, out _path);
		}
